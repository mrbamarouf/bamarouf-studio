...
export const destinations = [
  {
    ...
    en: { discipline: "Digital Experiences" },
    ar: { discipline: "التجارب الرقمية" },
  },
  {
    id: "nour",
    firstName: "NOUR",
    ...
    en: { discipline: "Graphic Design" },
    ar: { discipline: "التصميم الجرافيكي" },
  },
  {
    id: "khaled",
    firstName: "KHALED",
    ...
    en: { discipline: "Systems Engineering" },
    ar: { discipline: "هندسة الأنظمة" },
  },
] as const;
